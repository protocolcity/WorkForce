"""HTML surfaces for the WorkForce board — rendered pages.

CSS/JS constants and render_* functions. Data models live in api.roster.
"""
...
from ...api.roster import (
    ...
    OUTCOME_CLS,
    _kind_label, _city_folder_name, _ago, _utcnow, _fmt_fire,
    _launchctl_rota, _desk_json, _worker_queue, _platforms, _load_roster,
    _workplaces,
    _worker_flags, _worker_health, _law_stack, _contract_rules,
    _git_law_log,
)
